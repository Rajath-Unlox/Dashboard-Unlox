...
export default function Page() {
  ...
  React.useEffect(() => {
    fetch("http://localhost:5000/api/edulets/get-data")
      .then((res) => res.json())
      .then((users) => {
        ...
        // let users = [{
        //   name:'lucky',
        //   phone_number:"9573600707",
        //   email:"lucky@unlox.com",
        //   address:"HSR",
        //   city:"bengaluru",
        //   state:"karnataka",
        //   pincode:"560102",
        //   course:"WebDevelopment",
        //   course_month:"DEC2025",
        //   tracking_id:"ahdaskdhalhdadhakdha"
        // }]
  ...
  const [fileContent, setFileContent] = React.useState<any[]>([]); // For CSV data
